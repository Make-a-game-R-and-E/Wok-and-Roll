...
1. **השלמת כל השלבים בהצלחה** – לעבור משלב הקינוחים הראשוניים ועד להכנת מנות עיקריות מורכבות.
2. **הגעה לרמת שליטה גבוהה** – הכנת מנות ברמה הגבוהה ביותר במסעדה, מבלי לשרוף מנות או לקבל החזרות מהלקוחות.
...
- **תפריט יעדים במסך הראשי** – בכל זמן, השחקן יוכל להציג תפריט יעדים שיכלול את כל המשימות והשלבים שעליו להשלים כדי להתקדם.
...
1. **מי עושה מה ואיפה:** השחקן מתחיל את המשחק באווירת מטבח אסייתי עם סו-שף צעיר שמקבל משימה להכין את הקינוח הראשון. המשחק מציג לו מתכון פשוט עם הסבר קצר וידידותי.
...
3. **פקדים:** השחקן ישתמש במקלדת ועכבר כדי לגרור רכיבים, ללחוץ על כלים, ולבצע פעולות בהתאם להנחיות.
...
3. **פקדים:** השחקן ימשיך להשתמש במקךדת ועכבר כדי לגרור פריטים, ללחוץ על כפתורים בממשק לבחירת כלים, לערבב מצרכים, ולטגן/לאפות לפי הצורך.
...
2. **מתי ואיך:** בסיום המשמרת - השלב האחרון, השחקן יפעל במהירות לפי הדרישות של כל מנה ויהיה עליו להקפיד שלא לשרוף או להחזיר מנות כדי להשיג ניקוד מרבי.
3. **פקדים:** בעזרת מקךדת ועכבר, השחקן יבצע רצף פעולות זריזות – בחירת כלים, חיתוך, ערבוב, ואפייה – לפי הסדר והזמן הנדרש.
...
1. **חוקים לזמן הכנה**: כל שלב מוגבל בזמן, ושחקן שלא מספיק להכין מספיק מנות בזמן ייכשל וייאלץ לאבד נקודות.
2. **חוקים לשימוש בכלים ורכיבים**: כלים מסוימים יהיו זמינים רק בשלבים מתקדמים יותר, ושימוש ברכיבים לא מתאימים יוביל לניקוד שלילי.
...
1. **דיוק ומיומנות**: כל מנה מקבלת ניקוד לפי הדיוק שבו ביצע השחקן את השלבים – הכנת מנה בצורה מדויקת לפי ההנחיות תניב ציון גבוה.
2. **מהירות**: הכנת מנה בתוך הזמן המוגדר מעניקה לשחקן בונוס, בעוד שאיחור גורר הורדת נקודות.
3. **בחירת רכיבים נכונה**: אם השחקן בחר את הרכיבים הנכונים והשתמש בהם בהתאם למתכון, המנה תצליח, אחרת, השחקן יאבד נקודות.
...
2. **כלי מטבח**: כלים שונים כגון סירים, מחבתות, תנורים, סכינים מיוחדות ומיקסרים.
3. **זמן**: לכל שלב מוקצב זמן, שמנוצל להכנת המנות.

### איך המשאבים יועילו לשחקן
- **רכיבי בישול** מאפשרים לשחקן להכין את המנות הנדרשות כדי לעבור שלבים ולצבור נקודות.
- **כלי המטבח** פותחים אפשרויות להכנת מנות מתקדמות יותר, ומאפשרים לשחקן להשיג תוצאות איכותיות ודיוק גבוה.
...
2. **כלי מטבח**: כלים חדשים ייפתחו ככל שהשחקן מתקדם בשלבים ועומד ביעדים.
3. **זמן**: כל שלב יתחיל עם זמן קצוב, והשחקן יכול לצבור זמן נוסף כבונוס אם יסיים הכנות מוקדם.
...
- **כלים מתקדמים יפתחו בהדרגה**: כלים איכותיים ייפתחו רק לאחר השגת ניקוד מתאים והתקדמות בשלבים, כך שהשחקן צריך להתאמץ כדי להשיגם.

### איך המשחק יודיע לשחקן על המשאבים וכמותם
- **ממשק גרפי עם מדדים**: בפינה של המסך יהיה לוח שמציג את כמות הרכיבים, הזמן הנותר, והנקודות שצבר.
...
2. **דיוק ומורכבות מתגברת**: המנות הופכות למורכבות יותר ודורשות דיוק גבוה. אפילו טעות קטנה בבחירת רכיב או בכלי יכולה להוביל לכישלון במנה.
